...
$i=1;
	...
	foreach ($arr_data as $value) {
		...
		$id_pds = "p.id_sp='".$id_sp."' and p.nm_pd='".$value->nm_pd."' and p.tgl_lahir='".$value->tgl_lahir."' and p.nm_ibu_kandung='".$value->nm_ibu_kandung."'";
		...
		if (empty($id_pd['result'])) {
			...
			//if there's not siswa in mahasiswa, insert it
			$data_mhs = array_merge($data_mhs,$sp);
