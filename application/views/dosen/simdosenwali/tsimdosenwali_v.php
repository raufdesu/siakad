...
<table class="listing form" cellpadding="0" cellspacing="0">
	<tr>
		...
		<th>Prodi</th>
		<th>Angkatan</th>
		<th width="65" class="last">Aksi</th>
	</tr>
<?php $i=$no+1; foreach($browse_mhs->result() as $bm): ?>
	<tr>
		...
		<?php
			...
			*/
			$que = "SELECT * FROM simkrs WHERE nim = '".$bm->nim."' AND thajaran = '20121'";
			/* $d= mysql_num_rows($que);*/
			//echo $d['nim'];
			echo $this->auth->get_prodibynim($bm->nim)->namaprodi;
		?>
		</td>
