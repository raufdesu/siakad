...
<div class="top-bar-adm">
	...
	<a href="javascript:void(0)" class='browse-button' onclick='show("admin/simkrs/listview","#center-column")'> Browse</a>
	<?php if($this->session->userdata('sesi_krs_nim')){ ?>
	<a href="javascript:void(0)" class='browse-button' onclick='show("admin/simkrs/cetak_krs","#center-column")'> Print preview</a>
	<?php } ?>
	</div>
...
<?php
	...
	'url'=>site_url('dosen/simkrs/detail_mahasiswa'),
...
<div class="table">
	<table class="listing form" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td class="last">
				<input type="text" name="nim" readonly value='<?php echo $this->session->userdata('sesi_krs_nim')?>' class="required" size="8"/>
...
<table class="listing form" cellpadding="0" cellspacing="0">
	...
	if($this->session->userdata('sesi_krs_nim')){
		...
		<tr class='bg'>
			...
			<td>
				<a href="javascript:void(0)" onclick='show("admin/simkrs/delete2/<?php echo $bk->idkrs.'/'.$bk->kodemk?>","#center-column")'>
