...
function submitChangeKurikulum(){
	...
	load('prodi/simkurikulum/add/'+selected_kurikulum,'#center-column');
}

</script>
<?php echo $this->pquery->form_remote_tag(array(
	'url'=>site_url('prodi/simkurikulum/save'), 							
	...
	<table class="listing form" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td class="last">
				...
				<a href="javascript:void(0)" onclick='show("prodi/simkurikulum","#center-column")'>
					Batal &raquo; 
				</a>
			</td>
		</tr>
