...
<table class='listing form' cellpadding='0' cellspacing='0' width='100%'>
	...
	<tr>
		...
		<td class='first'>
		<a href="javascript:void(0)" onclick='show("prodi/simmktawar/pengambilmk/<?php echo $bm->kodemk?>/<?php echo $bm->namamk?>","#center-column")'>
			<?php echo $bm->namamk?>
		...
		<?php echo $this->pquery->form_remote_tag(array(
			'url'=>site_url('prodi/simmktawar/update_quota'), 'update'=>'#center-column', 'name'=>'cari', 'id'=>'simmktawar', 'type'=>'post'));
		?>
