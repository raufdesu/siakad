...
<div class="top-bar-adm">
	<div style="float:right">
		<select name="cbkelas" style="margin-right:-32px" onchange="submitGantiKelas()">
...
<div class="table">
<?php
	echo $this->pquery->form_remote_tag(array('url'=>site_url('admin/nilai/save_bydosen'),
		'update'=>'#confirm-column',	'name'=>'cari',	'id'=>'maspegawai',	'type'=>'post'));
?>
