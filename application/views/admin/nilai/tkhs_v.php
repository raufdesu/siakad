...
?>
<div id='noprint' style="float:right;margin-top:-90px;">
...
<table width="100%">
	<tr>
		...
		<td width="110"><b>Prodi</b></td><td width="200">: <?php echo $this->auth->get_prodibynim($nim)->namaprodi?></td>
	</tr>
	<tr>
