...
<?php echo $this->pquery->form_remote_tag(array('url'=>site_url('admin/simaktifsemester/save'),
...
<div class="table">
	...
	<table class="listing form" cellpadding="0" cellspacing="0">
		...
		<tr class="bg">
			...
			<td class="last">
				<input type="text" readonly value="<?php echo $this->input->post('nama')?>" name="nama" class="required" size="35"/>
		...
		<tr>
			...
			<td class="last">
				...
				<a href="javascript:void(0)" onclick='show("admin/simaktifsemester","#center-column")'>&laquo; Batal</a>
			</td>
		</tr>
	</table>
  <p>&nbsp;</p>
