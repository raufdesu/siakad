...
<?php
	...
	'url'=>site_url('admin/simdosenampu/index'), 'update'=>'#center-column',	'name'=>'cari',	'id'=>'maspegawai',	'type'=>'post'));
...
?>
	<tr>
		...
		<td class="first">
			<a href="javascript:void(0)" onclick='show("admin/simdosenampu/add/<?php echo $bm->npp?>","#center-column")'>
