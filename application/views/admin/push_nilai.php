...
//$token = 'acdbbc82c3b29f99e9096dab1d5eafb4';
	...
	$count = $db->fetch_custom("select *,nilai.id as id_krs from nilai inner join jurusan on nilai.kode_jurusan=jurusan.kode_jurusan where nilai.kode_mk='".$kodemk."' and nilai.nim='".$nim."' and status_error!=1");
	...
	if ($jumlah>=500) {
		...
		if ($i==0) {
			...
			$data = $db->fetch_custom("select *,nilai.id as id_krs from nilai inner join jurusan on nilai.kode_jurusan=jurusan.kode_jurusan where nilai.kode_mk='".$kodemk."' and nilai.nim='".$nim."' and status_error!=1");
