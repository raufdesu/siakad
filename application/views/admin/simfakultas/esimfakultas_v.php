...
<?php echo $this->pquery->form_remote_tag(array(
	...
	'id'=>'simfakultas',
	'type'=>'post'));
	foreach($detail_simfakultas as $dp):
?>
<div class="table">
	...
	<table class="listing form" cellpadding="0" cellspacing="0">
		...
		<tr class="bg">
			...
			<td class="last">
				<input type="text" name="kodefakultas" value="<?php echo $dp->kodefakultas?>" size="5"/>
				<input type="hidden" value="<?php echo $dp->kodefakultas?>" name="kodefakultas2" />
		...
		<tr class="bg">
			...
			<td class="last">
				<input type="text" name="namafakultas" value="<?php echo $dp->namafakultas?>" size="45"/>
		...
		<tr class="bg">
			...
			<td class="last">
				<input type="text" name="ijin" value="<?php echo $dp->ijin?>" size="30"/>
		...
		<tr class="bg">
			...
			<td class="last">
				<input type="text" name="status" value="<?php echo $dp->status?>" size="30"/>
		...
		<tr class="bg">
			...
			<td class="last">
				...
				<input type="text" readonly value="<?php echo $dp->kafakultas?>" name="namadosen" style="width:300px"/>
