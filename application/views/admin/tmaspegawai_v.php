...
<div class="top-bar-adm">
	...
	<a href="javascript:void(0)" class='navi add' onclick='show("admin/maspegawai/add","#center-column")'>
		Tambah
	</a>
	<?php endif ?>
...
?>
	<tr>
		...
		<td class="first">
			<a href="javascript:void(0)" onclick='show("admin/maspegawai/detail/<?php echo $bm->npp?>","#center-column")'>
				<?php echo $bm->nama; ?>
			</a>
		</td>
