...
<script type="text/javascript">
	...
	function searchFunction(str){
		load('admin/simmatrikulasi/cari_matakuliah/'+str,'#nama_mk');
	}
</script>
...
<div class="top-bar-adm">
	...
	<a href="javascript:void(0)" class='browse-button' onclick='show("admin/simmatrikulasi/listview","#center-column")'>
		<?php echo 'Browse'?>
	</a>
	<?php if($this->session->userdata('sesi_krs_nim')){ ?>
	<?php //echo anchor('admin/simkrs/cetak_krs','Print preview','class="print-button"');?>
	<?php } ?>
	</div>
...
<?php echo $this->pquery->form_remote_tag(array(
	'url'=>site_url('admin/simmatrikulasi/detail_mahasiswa'),
...
<?php
	...
	'url'=>site_url('admin/simmatrikulasi/save'), 'update'=>'#center-column', 'name'=>'pilih', 'id'=>'form',	'type'=>'post'));
?>
...
<script language="javascript">
	...
	function tanya(kodemk, nim){
		if(confirm('KONFIRMASI\nTekan OK untuk melanjutkan penghapusan data')){
			show("admin/simmatrikulasi/delete/"+kodemk+"/<?php echo $this->session->userdata('sesi_krs_nim')?>","#center-column");
		}else{
			return false;
		}
	}
