...
<div class="top-bar-adm">
	...
	<div style="float:right;margin-right:-32px;">
		<a href="javascript:void(0)" class="button" onclick='show("admin/simbap/input/<?php echo $id_kelas_dosen?>","#center-column")'>Input Materi</a>
		<a href="javascript:void(0)" class="button" onclick='show("admin/nilai","#center-column")'>Back</a>
	</div>
...
<?php
	...
	'url'=>site_url('admin/simbap/save_presensi'), 'update'=>'#confirm-column',	'name'=>'cari',	'id'=>'maspegawai',	'type'=>'post'));
?>
...
<table class="listing form" cellpadding="0" cellspacing="0">
	<tr>
		<th class="first">No.</th><th>NIM</th><th>Nama Mahasiswa</th><th width="41" class="last">Abs</th>
	</tr>
