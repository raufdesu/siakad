...
<div style="float:right;height:25px">
	<a href="javascript:void(0)" class="button" onclick='show("admin/simbap/browse","#center-column")'>Browse</a>
</div>
<?php
	echo $this->pquery->form_remote_tag(array(
	'url'=>site_url('admin/simbap/update'),
...
<div class="table">
	...
	<table class="listing form" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td class="first" width="172"><strong>Tanggal Kuliah</strong></td>
			<td class="last">
		...
		<tr class="bg">
			<td class="first" width="172"><strong>Keterangan</strong></td>
			<td class="last">
				<textarea name="keterangan" rows="2" cols="80"></textarea><?php echo form_error('materi')?>
			</td>
		</tr>
		<tr>
			<td class="first"></td>
			<td class="last">
				...
				<a href="javascript:void(0)" onclick='show("admin/simdosenampu/add/<?php echo $bap->npp?>","#center-column")'>
					<< Batal
				</a>
			</td>
		</tr>
...
<?php $i=1; foreach($browse_bap->result() as $bm): ?>
	<tr>
		...
		<td>
			<a href="javascript:void(0)" onclick='show("admin/simbap/input_presensi/<?php echo $bm->idbap?>","#center-column")' title='Presensi Mahasiswa'>
				<?php echo img('asset/images/design/detail_add.png')?>
			</a>
			<a href="javascript:void(0)" onclick='show("admin/simbap/edit/<?php echo $bm->idbap?>","#center-column")' title='Edit Materi'>
