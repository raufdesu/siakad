...
<div id='noprint' style="margin-top:-90px;float:right;">
...
<table class="khs-bottom" style="width:99%">
	<tr>
		...
		<td style="vertical-align:top"><?php echo $ipnya = substr($jums/$jumsks,0,4)?></td>
	</tr>
	<tr>
	...
	<tr>
		<td><br /><br /><br />
			<?php
				echo '<u>'.$this->auth->get_prodi($dm['kodeprodi'])->kaprodi.'</u><br />';
				echo 'NIDN.'.$this->auth->get_prodi($dm['kodeprodi'])->nidn;
			?>
		</td>
		<td></td>
	</tr>
