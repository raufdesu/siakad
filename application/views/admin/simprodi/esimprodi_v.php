...
<div class="table">
	...
	<table class="listing form" cellpadding="0" cellspacing="0">
		...
		<tr class="bg">
			...
			<td class="last">
				<input type="text" name="kodeprodi" value="<?php echo $dp->kodeprodi?>" size="5" readonly />
		...
		<tr class="bg">
			...
			<td class="last">
				<select name="kodefakultas" id="dropdown">
					<option value=""></option>
					<?php foreach($fakultas as $f):?>
					<option <?php if($dp->kodefakultas == $f->kodefakultas) echo 'selected'?> value="<?php echo $f->kodefakultas?>"><?php echo $f->namafakultas?></option>
					<?php endforeach; ?>
				</select>
