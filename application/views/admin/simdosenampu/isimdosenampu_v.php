...
<div class="table">
	<table class="listing form" cellpadding="0" cellspacing="0">
		<tr>
			...
			<th>SKS</th><th>Ruang</th><th>Kelas</th><!--<th>BAP</th>--><th>Mhs</th><th width="35">#</th>
		</tr>
		...
		<tr class="bg">
			...
			<?php } ?>
			<?php if($this->session->userdata('sesi_status') == 'admin'): ?>
			<a href="javascript:void(0)" title="Kelola BAP" onclick="load_into_box('admin/simdosenampu/edit_ampuan/<?php echo $ds->id_kelas_dosen?>');">
