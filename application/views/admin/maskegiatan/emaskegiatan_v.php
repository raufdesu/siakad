...
<?php
	...
	'id'=>'maskegiatan',
	'type'=>'post'));
	foreach($detail_maskegiatan as $dk):
	echo form_hidden('thajaran', $this->session->userdata('sesi_krs_thajaran_aktif'));
	echo form_hidden('idkegiatan', $dk->idkegiatan);
?>
<div class="table">
	...
	<table class="listing form" cellpadding="0" cellspacing="0">
		...
		<tr class="bg">
			...
			<td class="last">
				<input type="text" value="<?php echo $dk->namakegiatan?>" name="namakegiatan" size="60"/>
		...
		<tr class="bg">
			...
			<td class="last">
				<select name="tingkat">
					<option value=""></option>
					<option <?php if($dk->tingkat == 'Perguruan Tinggi') echo 'selected';?> value="Perguruan Tinggi">Perguruan Tinggi</option>
					<option <?php if($dk->tingkat == 'Kopertis') echo 'selected';?> value="Kopertis">Kopertis</option>
					<option <?php if($dk->tingkat == 'Propinsi') echo 'selected';?> value="Propinsi">Propinsi</option>
					<option <?php if($dk->tingkat == 'Nasional') echo 'selected';?> value="Nasional">Nasional</option>
				</select>
		...
		<tr class="bg">
			...
			<td class="last">
				<input type="text" name="tglmulai" value="<?php echo tgl_indo($dk->tglmulai)?>" class="required" size="8"/>
		...
		<tr class="bg">
			...
			<td class="last">
				<input type="text" name="tglselesai" value="<?php echo tgl_indo($dk->tglselesai)?>" class="required" size="8"/>
		...
		<tr>
			...
			<td class="last">
				<input type="hidden" value="<?php echo $dk->ttd1?>" name="npp1" />
				<input type="text" readonly value="<?php echo $dk->nmpembimbing1?>" name="pembimbing1" size="40"/>
		...
		<tr class="bg">
			...
			<td class="last">
				<input type="hidden" value="<?php echo $dk->ttd2?>" name="npp2" />
				<input type="text" readonly value="<?php echo $dk->nmpembimbing2?>" name="pembimbing2" size="40"/>
