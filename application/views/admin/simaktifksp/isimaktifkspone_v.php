...
<?php echo $this->pquery->form_remote_tag(array('url'=>site_url('admin/simaktifksp/save'),
	...
	<table class="listing form" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td class="last">
				...
				<a href="javascript:void(0)" onclick='show("admin/simaktifksp","#center-column")'>&laquo; Batal</a>
			</td>
		</tr>
	</table>
  <p>&nbsp;</p>
