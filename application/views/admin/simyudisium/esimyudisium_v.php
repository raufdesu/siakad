...
<div class="table">
	...
	<table class="listing form" cellpadding="0" cellspacing="0">
		...
		<tr class="bg">
			...
			<td class="last">
				<input type="hidden" name="idyudisium" value="<?php echo $yud->idyudisium?>" />
				<input type="text" name="noyudisium" value="<?php echo $yud->noyudisium?>" class="required" size="30"/>
		...
		<tr class="bg">
			...
			<td class="last">
				<input type="text" name="thajaran" size="3" maxlength="5" value="<?php echo $yud->thajaran?>" />
		...
		<tr class="bg">
			...
			<td class="last">
				<input type="text" name="tglyudisium" value="<?php echo tgl_indo($yud->tglyudisium)?>" maxlength="10" class="required" size="8"/>
