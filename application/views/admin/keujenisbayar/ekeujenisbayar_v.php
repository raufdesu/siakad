...
<div class="table">
	...
	<table class="listing form" cellpadding="0" cellspacing="0">
		...
		<tr class="bg">
			...
			<td class="last">
				<input type="hidden" value="<?php echo $tk->idjenisbayar?>" name="idjenisbayar" />
				<input type="text" value="<?php echo $tk->jenisbayar?>" name="jenisbayar" size="25" />
		...
		<tr class="bg">
			...
			<td class="last">
				<select name='kodeprodi' style="width:290px !important;">
					<option <?php if($tk->kodeprodi == '') echo 'selected'; ?> value="">Prodi Keseluruhan</option>
					<?php foreach($browse_prodi as $bp):?>
					<option <?php if($tk->kodeprodi == $bp->kodeprodi) echo 'selected'; ?> value="<?php echo $bp->kodeprodi?>"><?php echo $bp->namaprodi?></option>
					<?php endforeach; ?>
				</select>
		...
		<tr class="bg">
			...
			<td class="last">
				<input type="text" value="<?php echo $tk->angkatan?>" name="angkatan" size="4" />
		...
		<tr class="bg">
			...
			<td class="last">
				<input type="text" value="<?php echo $tk->gelombang?>" name="gelombang" size="4" />
		...
		<tr class="bg">
			...
			<td class="last">
				Rp. <input type="text" value="<?php echo $tk->totalbiaya?>" name="totalbiaya" size="10" />,00
