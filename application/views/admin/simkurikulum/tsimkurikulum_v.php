...
<div class="top-bar-adm">
	...
	<a href="javascript:void(0)" class='navi add' onclick='show("admin/simkurikulum/add","#center-column")'>
		Tambah
	</a>
	<?php endif ?>
...
<?php
	...
	'url'=>site_url('admin/simkurikulum/index'),
...
<?php
	echo form_close();
	echo $this->pquery->form_remote_tag(array(
	'url'=>site_url('admin/simkurikulum/index'), 'update'=>'#center-column',	'name'=>'cari',	'id'=>'maspegawai',	'type'=>'post'));
...
?>
	<tr>
		...
		<td class="first">
			<a href="javascript:void(0)" onclick='show("admin/simkurikulum/detail/<?php echo $bm->kodemk?>","#center-column")'>
				<?php echo $bm->namamk; ?>
			</a>
		</td>
		...
		<?php if($this->session->userdata('sesi_status') == 'admin'):?>
		<td class="first">
			<a href="javascript:void(0)" onclick='show("admin/simkurikulum/edit/<?php echo $bm->kodemk?>","#center-column")'>
